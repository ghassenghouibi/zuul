...
public class Game {
    ...
    private void createRooms()
    {
        ...
        paris8 = new Room("Paris8, il semble que vous avez d�couvert une �le absente sur votre carte, et si vous l'exploriez ?");
        rafel = new Room("Rafel, ~votre log pose n'arr�te pas de s'agiter ...~");
